...
<#macro emailLayout subject="" logoUrl="">
<!doctype html>
<html lang="it">
          ...
          <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
           ...
           <tr>
              <td class="wrapper"
                ...
                valign="top">
                <img src="${logoUrl}" alt="" width="80" height="40" border="0" style="border:0; outline:none; text-decoration:none; display:block;"/>
              </td>
            </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td class="content-block"
                  ...
                  <br/><br/>
                  <span>
                    <a href="https://onit.it/it/legal/informativa-privacy" style="text-decoration: underline; color: #9a9ea6; font-size: 16px; text-align: center;">
