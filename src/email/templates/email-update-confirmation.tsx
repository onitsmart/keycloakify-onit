...
export const Template = ({ locale, themeName } : TemplateProps) => {
  ...
  return (
    <EmailLayout locale={locale} emailSubject={messages["emailUpdateConfirmationSubject"]} themeName={themeName}>
      <Container>
        <Raw content={formatMessage(
            messages["emailUpdateConfirmationBodyHtml"],
            exp("realmName"),
            exp("newEmail"),
            exp("link"),
...
export const getSubject: GetSubject = async (props) => {
  ...
  return messages["emailUpdateConfirmationSubject"];
};